...
class WordDocument {
    ...
    private final String DOCUMENT_FILE = 'word/document.xml'
    private final String IMAGE_PATH = 'word/media'
    private final String RELATIVE_IMAGE_PATH = 'media'
    ...
    private void writeContentTypes() {
        ...
        zipStream << new StreamingMarkupBuilder().bind {
            ...
            Types {
                ...
                Override(PartName: "/${DOCUMENT_FILE}", ContentType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml")
            }
        }.toString().getBytes('UTF-16')
        zipStream.closeEntry()
